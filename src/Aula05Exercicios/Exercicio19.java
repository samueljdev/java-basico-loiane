...
public class Exercicio19 {
    ...
    aritmética simples das notas informadas armazenando o resultado em um vetor “Result”
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < resultados.length; i++) {
            if (resultados[i] >= 7) {
                System.out.println("Aluno: " + resultados[i] + " Aprovado");
            } else {
                System.out.println("Aluno: " + resultados[i] + " Reprovado");
            }
        }
    }
}
