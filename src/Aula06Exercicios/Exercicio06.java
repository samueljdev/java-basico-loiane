...
public class Exercicio06 {
    /* Faça um programa para jogar o jogo da velha. O programa deve permitir que dois jogadores
     ...
     e quem foi o vencedor (jogador1 ou jogador2). A cada nova jogada, o programa deve atualizar
